...
public class GenerateOutput extends javax.swing.JDialog {
    ...
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(GenerateOutput.class);
	...
	if (returnVal == JFileChooser.APPROVE_OPTION) {
		...
		JOptionPane.showMessageDialog(this, "Please save the file with a valid extension corresponding to the file type you are saving", "File cannot be saved in the requested location",
	...
	try {
	    ...
	    log.error("Could not get create a model", e);
	}

...
public class BhashaDefaultFrame extends JFrame {
    ...
    public BhashaDefaultFrame(PageContainer pageContainer,
	    Locale[] supportedLanguages, Locale defaultLocale) {
	bhashaView = new BhashaDefaultPanelView(this, pageContainer,
		supportedLanguages, defaultLocale);
	setPageContainer(pageContainer);

	ImageIcon img = new ImageIcon(getClass().getResource(
		"/images/BanglaLogo.jpg"));
	...
	tabbedPane.addChangeListener(new ChangeListener() {
		...
		if (tabbedPane.getSelectedComponent() == rawHtmlViewPane) {
		    try {
			XHtmlGenerator htmlGenerator = new XHtmlGenerator(
				GenerateOutput.getPageModels(getPageContainer()
					.getPageVector()));
